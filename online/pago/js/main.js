jQuery(document).ready(function($){
    ...
    function prevSection(event) {
        ...
        if( !animating && !visibleSection.is(":first-child") ) {
					...
					if(!animating && visibleSection.is(":nth-of-type(2)") ) {
						console.log('seccion 1');
						$( "#nav-next a" ).html('<span class="glyphicon glyphicon-chevron-down"></span><br/>DONA AHORA</a>');
					}
					if(!animating && visibleSection.is(":nth-of-type(3)") ) {
						console.log('seccion 2');
						$( "#nav-prev a" ).html('<span class="glyphicon glyphicon-chevron-up"></span><br/>LO QUE HACEMOS</a>');
						$( "#nav-next a" ).html('<span class="glyphicon glyphicon-chevron-down"></span><br/>CUENTAS CLARAS</a>');
					}
    ...
    function nextSection(event) {
        ...
        if(!animating && !visibleSection.is(":last-of-type") ) {
					if(!animating && visibleSection.is(":nth-of-type(2)") ) {
						...
						$( "#nav-prev a" ).html('<span class="glyphicon glyphicon-chevron-up"></span><br/>DONA AHORA</a>');
						// presupuesto();
					}
					if(!animating && visibleSection.is(":nth-of-type(1)") ) {
						console.log('seccion 2');
						$( "#nav-prev a" ).html('<span class="glyphicon glyphicon-chevron-up"></span><br/>LO QUE HACEMOS</a>');
						$( "#nav-next a" ).html('<span class="glyphicon glyphicon-chevron-down"></span><br/>CUENTAS CLARAS</a>');
					}
